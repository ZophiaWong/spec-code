...
## Purpose
Session lifecycle management including creating, listing, continuing, and forking sessions tied to repo paths, with SQLite persistence and renderer-side Zustand store.
